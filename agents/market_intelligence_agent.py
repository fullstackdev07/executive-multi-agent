...
# import json
# import requests  # For web scraping (if needed)
# import re
...
1. **Company Data:** Research and describe the company "{company_name}" in detail. Include revenue, number of employees, business lines, history, ownership, etc. Use the documents provided and your internal knowledge.
2. **Market Overview:** An overview of the market in which the company operates.
3. **Company Positioning:** Compare the company to competitors. Include SWOT analysis.
...
Report:"""
    ...
    def run(self, input_data: dict) -> str:
        ...
        # Check for nonsense or invalid inputs
        if any(value == "INVALID_INPUT" for value in input_data.values()):
            return "I'm sorry, I couldn't understand your input. Please provide more specific or recognizable company information."
...
If the input is meaningless, nonsense, or gibberish, respond with: INVALID_INPUT

If any field is not known, return "Unknown".

Respond with a JSON object or the string "INVALID_INPUT".
"""
        ...
        if "INVALID_INPUT" in information:
            return {
                "company_name": "INVALID_INPUT",
                "company_location": "INVALID_INPUT",
                "geography": "INVALID_INPUT",
            }
        ...
        try:
            ...
            print(f"Warning: Could not extract company details. Raw: {information}")
            return {
                "company_name": "INVALID_INPUT",
                "company_location": "INVALID_INPUT",
                "geography": "INVALID_INPUT",
