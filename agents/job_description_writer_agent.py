...
# job_description_writer_agent.py
...
#     def run(self, job_title: str, client_name: str, market_intelligence: str, call_transcript: str, job_spec: str, additional_documents: str) -> str:
#         input_data = {
#             "job_title": job_title,
#             "client_name": client_name,
#             "market_intelligence": market_intelligence,
